...
pack: compile-schemas
	gnome-extensions pack --force --extra-source=dock.js --extra-source=animationManager.js --extra-source=folderManager.js --extra-source=intellihide.js --extra-source=tests/
